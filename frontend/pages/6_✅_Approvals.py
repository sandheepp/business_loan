...
page_config_dark("Approvals", "✅")

API = st.session_state.get("api_url", "http://localhost:8000")

st.sidebar.markdown("""
<div style="padding:0.5rem 0 1rem;">
  <div style="font-size:1.3rem;font-weight:800;color:#FFFFFF;">Approvals</div>
  <div style="font-size:0.75rem;color:#8A8FA8;">Decision Workflow</div>
</div>
